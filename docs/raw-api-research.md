# RAW API Research (preserved as-is from req.md)

> This file preserves the original API research exactly as provided.
> Do not edit — corrections and annotations live in `shopify-connection-verification.md`.
